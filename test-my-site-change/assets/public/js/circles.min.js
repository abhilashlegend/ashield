  ...
  Circles.prototype = {
    ...
    htmlifyNumber: function(number, integerPartClass, decimalPartClass) {
      ...
      var parts = (number + '').split('.'),
          html = '<div class="site-score">Site Score</div>'
          html  += '<span id="integer-id" class="' + integerPartClass + '">' + parts[0]+'</span>';

      if (parts.length > 1) {
              html += '.<span id="decimal-id" class="' + decimalPartClass + '">' + parts[1].substring(0, 2) + '</span>';
          }
      return html;
    },
