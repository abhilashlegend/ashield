...
function tms_admin_menus() {
  ...
  /* main menu */
    ...
    add_submenu_page (
      'testmysite',
      __( 'Edit Test My Site Report', 'tms-edit-report'),
      __( 'Edit Test My Site Report', 'tms-edit-report'),
      'manage_options',
      'tms_edit_report',
      'tms_edit_report_markup'
    );
}
...
/* Test my site report page */

function tms_page_markup() {
    //Double check user capabilities
    if( !current_user_can('manage_options')) {
      return;
    }

    include( plugin_dir_path( __FILE__ ) . './templates/admin/report.php');
}

function tms_edit_report_markup() {
  ...
  include( plugin_dir_path( __FILE__ ) . './templates/admin/edit-report.php');
