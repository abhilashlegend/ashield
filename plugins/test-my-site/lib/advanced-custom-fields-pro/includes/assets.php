...
class ACF_Assets {
	...
	*/
	...
	function register_scripts() {
		...
		// scripts
		wp_register_script('acf-input', acf_get_url("assets/js/acf-input.js"), array('jquery', 'jquery-ui-sortable', 'jquery-ui-resizable'), $version );
		wp_register_script('acf-field-group', acf_get_url("assets/js/acf-field-group.js"), array('acf-input'), $version );
