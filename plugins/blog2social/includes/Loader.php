...
//END MetaTags
    ...
    public function defineText() {
        ...
        define('B2S_PLUGIN_NETWORK_ERROR', serialize(array('DEFAULT' => esc_html__('Your post could not be posted.', 'blog2social'),
            ...
            'IMAGE_FOR_CURATION' => esc_html__('There was no image in the meta data of the linked post. Posts without images cannot be shared on image networks.', 'blog2social'), // special for content curation V.5.0.0
...
//$parent_slug, $page_title, $menu_title, $capability, $menu_slug, $function
        ...
        $subPages[] = add_submenu_page('blog2social', esc_html__('Posts & Sharing', 'blog2social'), esc_html__('Posts & Sharing', 'blog2social'), 'blog2social_access', 'blog2social-post', array($this, 'b2sPost'));
    ...
    public function createToolbarMenu() {
        ...
        $wp_admin_bar->add_node(array(
            'id' => 'blog2social-post',
            'title' => esc_html__('Posts & Sharing', 'blog2social'),
        ...
        $wp_admin_bar->add_node(array(
            ...
            'title' => esc_html__('Content Curation', 'blog2social'),
