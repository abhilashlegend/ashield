...
jQuery('.es-field-wrap > label').attr('for','es_email');
jQuery('.es-field-wrap > label').html('<input aria-label="email" class="es_required_field es_txt_email" type="email" name="email" id="es_mail" value="" placeholder="Your email address" required="">');
document.getElementsByClassName('es_txt_email')[0].placeholder='Your email address';
jQuery('.es_spinner_image img').attr('alt','');

// When the user scrolls the page, execute myFunction 
window.onscroll = function() {bmgFixHeader()};
...
jQuery(function(){
  ...
  jQuery("textarea").bind("checkval",function(){
    var label = jQuery(this).prev("label");
    if(this.value !== ""){
      label.addClass(showClass);
    } else {
...
jQuery(document).ready(function() {
	jQuery("._2zIir_wMTE").click(function() {
		alert('sdfsdfs');
		jQuery("._101o4n6kwY").attr('id','name-error');
	});
})