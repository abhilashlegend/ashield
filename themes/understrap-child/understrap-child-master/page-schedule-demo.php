...
<div class="wrapper page schedule-demo-page" id="page-wrapper">
<img src="<?php echo get_stylesheet_directory_uri();?>/img/schedule_demo.png" class="schedule-demo-banner-img" alt="" />
	<div class="<?php echo esc_attr( $container ); ?>" role="main" id="content" tabindex="-1">
		...
		<div class="row">
			<div class="col-md-6">
				<h1 style="color: #006699;"> Schedule Demo</h1>
				<p class="bmg-form-heading">Enter your information below, and we will reach out to schedule a demo</p>
				<?php
	...
	if($success && $admin_mail) {
			$output = '<div class="alert alert-success alert-dismissible fade show" role="alert">
	  				 Thank you! One of our compliance professionals will be in touch to schedule your demo.
	  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
	    <span aria-hidden="true">&times;</span>
	  </button>
	</div>';
		$name = $email = $phone = $url = $company = '';
	}
